...
function endGame() {
  ...
  els.endTitle.textContent = isOralMode ? '🎤 Oral Practice Complete!' : 'Game Over!';
  ...
  els.endTopicLabel.textContent = `${state.selectedSubject} · Primary ${state.selectedLevel} · ${isOralMode ? 'Oral Mode' : 'Classic'}`;
