...
const BATTLE_PASS_REWARDS = [
  ...
  { level: 5, free: { type: 'avatar', category: 'accessories', item: 'glasses-round' }, premium: { type: 'crate', rarity: 'rare' } },
  { level: 6, free: { type: 'coins', amount: 125 }, premium: { type: 'avatar', category: 'shirts', item: 'hoodie-gray' } },
  ...
  { level: 10, free: { type: 'coins', amount: 200 }, premium: { type: 'avatar', category: 'hats', item: 'crown' } },
  { level: 11, free: { type: 'crate', rarity: 'rare' }, premium: { type: 'coins', amount: 400 } },
  { level: 12, free: { type: 'coins', amount: 225 }, premium: { type: 'avatar', category: 'shirts', item: 'tee-blue' } },
  { level: 13, free: { type: 'avatar', category: 'hats', item: 'cap-red' }, premium: { type: 'crate', rarity: 'rare' } },
  ...
  { level: 16, free: { type: 'coins', amount: 275 }, premium: { type: 'avatar', category: 'back', item: 'cape-red' } },
  { level: 17, free: { type: 'avatar', category: 'faces', item: 'cool' }, premium: { type: 'crate', rarity: 'rare' } },
  { level: 18, free: { type: 'coins', amount: 300 }, premium: { type: 'avatar', category: 'back', item: 'wings' } },
  { level: 19, free: { type: 'crate', rarity: 'rare' }, premium: { type: 'avatar', category: 'faces', item: 'star' } },
  { level: 20, free: { type: 'coins', amount: 500 }, premium: { type: 'avatar', category: 'hats', item: 'crown' } },
];
...
function getBodyLayerHtml(skinColor) {
  ...
  return `<svg class="qbit-layer qbit-layer-body" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
...
let battlePassState = {
  ...
  claimedRewards: [], // Array of {level, track} objects
};
...
function renderBattlePass() {
  ...
  BATTLE_PASS_REWARDS.forEach(reward => {
    ...
    const canClaimFree = reward.level <= battlePassState.level && !isFreeClaimed;
    ...
    const canClaimPremium = battlePassState.premiumUnlocked && reward.level <= battlePassState.level && !isPremiumClaimed;
